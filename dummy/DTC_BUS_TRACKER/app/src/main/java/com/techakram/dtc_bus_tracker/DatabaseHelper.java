...
import com.techakram.dtc_bus_tracker.ui.ViewRouteActivity;
...
public class DatabaseHelper extends SQLiteOpenHelper
{
    ...
    public final static String DATABASE_PATH = "/data/data/com.techakram.dtc_bus_tracker/databases/";
    ...
    public LinkedList<String> getAutoFill() {
        ...
        Cursor c = myDatabase.rawQuery(query, null);
       // Log.d("error", "getAutoFill: "+c.getString(0));
        c.moveToFirst();
